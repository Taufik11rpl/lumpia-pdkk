...
<div class="slider-container">
			...
			<div id="mainSlider" class="nivoSlider slider-image">
				<img src="{{URL::to('assets/images/slider/1.jpg')}}" alt="" title="#htmlcaption1"/>
				<img src="{{URL::to('assets/images/slider/3.jpg')}}" alt="" title="#htmlcaption2"/>
				<img src="{{URL::to('assets/images/slider/2.jpg')}}" alt="" title="#htmlcaption3"/>
			</div>
			<!-- Slider Caption 1 -->
        		...
        		<div class="row">
        			...
        			<div class="col-md-6">
        				<div class="welcome-about-img">
        					<img src="{{URL::to('assets/images/about/home-about.jpg')}}" alt="">
        				</div>
        			</div>
        		</div>
        	</div>
										...
										<div class="dises-show text-center">
											<div class="row">
												<div class="col-lg-4 col-md-6">
													<div class="single-disesh">
														<div class="disesh-img">
															<a href="#"><img src="{{URL::to('assets/images/dish/1.png')}}" alt=""></a>
														</div>
												...
												<div class="col-lg-4 col-md-6">
													<div class="single-disesh">
														<div class="disesh-img">
															<a href="#"><img src="{{URL::to('assets/images/dish/2.png')}}" alt=""></a>
														</div>
														<div class="disesh-desc pt-50">
															<h3><a href="#">Dish Name Here</a></h3>
															<p class="price">$100</p>
												...
												<div class="col-lg-4 d-lg-block d-md-none d-block">
													<div class="single-disesh">
														<div class="disesh-img">
															<a href="#"><img src="{{URL::to('assets/images/dish/3.png')}}" alt=""></a>
														</div>
														<div class="disesh-desc pt-50">
															<h3><a href="#">Dish Name Here</a></h3>
															<p class="price">$100</p>
